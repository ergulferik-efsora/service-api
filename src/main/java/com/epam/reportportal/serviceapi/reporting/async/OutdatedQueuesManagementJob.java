...
package com.epam.reportportal.serviceapi.reporting.async;

import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.DEFAULT_QUEUE_ROUTING_KEY;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.REPORTING_EXCHANGE;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.REPORTING_QUEUE_PREFIX;
