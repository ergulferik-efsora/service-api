...
package com.epam.reportportal.serviceapi.reporting.async.exception;

import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.REPORTING_PARKING_LOT;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.RETRY_EXCHANGE;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.TTL_QUEUE_M;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.TTL_QUEUE_MS;
import static com.epam.reportportal.serviceapi.reporting.async.config.ReportingTopologyConfiguration.TTL_QUEUE_S;
...
import com.epam.reportportal.serviceapi.reporting.async.config.MessageHeaders;
