...
import com.epam.reportportal.serviceapi.infrastructure.persistence.commons.ReportPortalUser.OrganizationDetails.ProjectDetails;
...
public class ReportPortalUser extends User {
  ...
  public static class ReportPortalUserBuilder {
    ...
    public ReportPortalUser fromUser(com.epam.reportportal.serviceapi.infrastructure.persistence.entity.user.User user) {
