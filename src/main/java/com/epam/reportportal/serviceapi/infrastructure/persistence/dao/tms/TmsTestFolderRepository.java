...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.tms.TmsTestFolderIdWithCountOfTestCases;
...
public interface TmsTestFolderRepository extends ReportPortalRepository<TmsTestFolder, Long> {
   ...
   */
  @Query(
      "SELECT new com.epam.reportportal.serviceapi.infrastructure.persistence.entity.tms."
   ...
   */
  @Query("SELECT new com.epam.reportportal.serviceapi.infrastructure.persistence.entity.tms."
