...
public interface TestItemRepositoryCustom extends FilterableRepository<TestItem> {
   ...
   * {@link Project} with provided `projectId` and
   ...
   * {@link FilterTarget#LAUNCH_TARGET} and
   * {@link FilterTarget#TEST_ITEM_TARGET}
   *
   * @param isLatest         Flag for retrieving only latest launches
   ...
   * {@link LogLevel#ERROR_INT} excluding {@link TestItem}
