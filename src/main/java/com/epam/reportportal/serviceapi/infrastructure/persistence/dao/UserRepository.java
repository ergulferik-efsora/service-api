...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.user.UserAuthProjection;
...
public interface UserRepository extends ReportPortalRepository<User, Long>, UserRepositoryCustom {
   ...
   */
  @Query("SELECT new com.epam.reportportal.serviceapi.infrastructure.persistence.entity.user.UserIdFullNameProjection(u.id, u.fullName) FROM User u WHERE u.id IN :userIds")
