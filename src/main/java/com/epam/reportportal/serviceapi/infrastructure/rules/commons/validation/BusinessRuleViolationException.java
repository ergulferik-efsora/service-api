...
package com.epam.reportportal.serviceapi.infrastructure.rules.commons.validation;


import static com.epam.reportportal.serviceapi.infrastructure.rules.commons.validation.Suppliers.trimMessage;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ReportPortalException.MAX_ERROR_MESSAGE_LENGTH;
