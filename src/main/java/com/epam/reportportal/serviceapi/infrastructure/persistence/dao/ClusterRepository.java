...
public interface ClusterRepository extends ReportPortalRepository<Cluster, Long>,
  ...
  @Query(value =
      "SELECT new com.epam.reportportal.serviceapi.infrastructure.model.launch.cluster.ClusterInfoResource(c.id, c.indexId as index, c.launchId, c.message, count(cti.itemId) as matchedTests) "
