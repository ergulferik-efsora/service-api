...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.GLOBAL_INTEGRATION_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.PROJECT_INTEGRATION_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.ResultFetchers.INTEGRATION_FETCHER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.tables.JIntegration.INTEGRATION;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.tables.JIntegrationType.INTEGRATION_TYPE;
