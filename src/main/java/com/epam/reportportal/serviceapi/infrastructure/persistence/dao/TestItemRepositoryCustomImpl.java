...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.FilterTarget.FILTERED_ID;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.FilterTarget.FILTERED_QUERY;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.QueryBuilder.retrieveOffsetAndApplyBoundaries;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.constant.LogRepositoryConstants.ITEM;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.ATTACHMENTS_COUNT;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.HAS_CONTENT;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.NESTED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.constant.WidgetContentRepositoryConstants.HISTORY;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.INDEX_TEST_ITEM_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.ISSUE_TYPE_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.NESTED_STEP_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.RecordMappers.TEST_ITEM_RECORD_MAPPER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_CLIPPED_FETCHER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_FETCHER;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_RETRY_FETCHER;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.Tables.ISSUE_TYPE_PROJECT;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.tables.JIssueType.ISSUE_TYPE;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.dao.util.TimestampUtils;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.ItemPathName;
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.LaunchPathName;
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.NestedStep;
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.PathName;
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.TestItem;
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.item.history.TestItemHistory;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.Tables;
import com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.enums.JIssueGroupEnum;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.jooq.tables.JTestItem;
