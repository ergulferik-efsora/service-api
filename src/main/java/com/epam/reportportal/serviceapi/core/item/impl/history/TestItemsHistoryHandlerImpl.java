...
package com.epam.reportportal.serviceapi.core.item.impl.history;

import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MAX_HISTORY_DEPTH_BOUND;
import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MIN_HISTORY_DEPTH_BOUND;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.UNABLE_LOAD_TEST_ITEM_HISTORY;
...
import com.epam.reportportal.serviceapi.core.item.impl.history.provider.HistoryProviderFactory;
...
import com.epam.reportportal.serviceapi.ws.converter.utils.ResourceUpdater;
import com.epam.reportportal.serviceapi.ws.converter.utils.ResourceUpdaterProvider;
import com.epam.reportportal.serviceapi.ws.converter.utils.item.content.TestItemUpdaterContent;
...
public class TestItemsHistoryHandlerImpl implements TestItemsHistoryHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<TestItemHistoryElement> getItemsHistory(
  ...
  private com.epam.reportportal.serviceapi.model.Page<TestItemHistoryElement> buildHistoryElements(
