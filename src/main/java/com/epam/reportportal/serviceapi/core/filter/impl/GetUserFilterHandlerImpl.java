...
public class GetUserFilterHandlerImpl implements GetUserFilterHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<UserFilterResource> getUserFilters(String projectName, Pageable pageable,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<OwnedEntityResource> getFiltersNames(
