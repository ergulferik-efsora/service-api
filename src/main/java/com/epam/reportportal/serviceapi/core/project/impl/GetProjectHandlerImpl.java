...
public class GetProjectHandlerImpl implements GetProjectHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<UserResource> getProjectUsers(MembershipDetails membershipDetails,
      Filter filter,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<SearchUserResource> getUserNames(String value,
