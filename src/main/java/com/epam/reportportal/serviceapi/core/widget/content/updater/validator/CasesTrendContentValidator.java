...
import static com.epam.reportportal.serviceapi.core.widget.util.ContentFieldPatternConstants.EXECUTIONS_TOTAL_REGEX;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates.equalTo;

import com.epam.reportportal.serviceapi.core.widget.util.ContentFieldMatcherUtil;
...
import com.epam.reportportal.serviceapi.core.widget.util.ContentFieldPatternConstants;
...
public class CasesTrendContentValidator implements WidgetValidatorStrategy {
   ...
   * {@link ContentFieldPatternConstants#EXECUTIONS_TOTAL_REGEX}
   *
