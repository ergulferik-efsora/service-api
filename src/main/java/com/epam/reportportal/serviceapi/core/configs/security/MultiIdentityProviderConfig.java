...
package com.epam.reportportal.serviceapi.core.configs.security;

import static com.epam.reportportal.serviceapi.core.configs.security.UserResolverType.EXTERNAL;

import com.epam.reportportal.serviceapi.auth.userdetails.DefaultUserDetailsService;
import com.epam.reportportal.serviceapi.auth.userdetails.ExternalUserDetailsService;
import com.epam.reportportal.serviceapi.core.configs.security.converters.ExternalJwtConverter;
import com.epam.reportportal.serviceapi.core.configs.security.converters.ReportPortalJwtConverter;
