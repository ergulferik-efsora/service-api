...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.FAILED_TEST_ITEM_ISSUE_TYPE_DEFINITION;
...
import static com.epam.reportportal.serviceapi.util.ItemInfoUtils.extractAttribute;
import static com.epam.reportportal.serviceapi.util.ItemInfoUtils.extractAttributeResource;
...
import com.epam.reportportal.serviceapi.core.analyzer.auto.impl.LogIndexerService;
import com.epam.reportportal.serviceapi.core.events.MessageBus;
import com.epam.reportportal.serviceapi.core.events.activity.ItemIssueTypeDefinedEvent;
import com.epam.reportportal.serviceapi.core.events.activity.LinkTicketEvent;
...
import com.epam.reportportal.serviceapi.core.item.TestItemService;
...
import com.epam.reportportal.serviceapi.infrastructure.rules.commons.validation.BusinessRuleViolationException;
...
import com.epam.reportportal.serviceapi.model.item.ExternalIssueRQ;
...
import com.epam.reportportal.serviceapi.ws.converter.builders.IssueEntityBuilder;
