...
package com.epam.reportportal.serviceapi.core.log.impl;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.LOG_NOT_FOUND;
...
import com.epam.reportportal.serviceapi.core.log.LogService;
...
public class GetLogHandlerImpl implements GetLogHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<LogResource> getLogs(@Nullable String path,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<?> getNestedItems(Long parentId,
      MembershipDetails membershipDetails,
