...
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.ActivityContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.BugTrendChartContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.CasesTrendContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.ChartInvestigatedContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.ComponentHealthCheckContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.CumulativeTrendChartValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.FlakyCasesTableContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.LaunchExecutionAndIssueStatisticsContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.LaunchesComparisonContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.LaunchesDurationContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.LaunchesTableContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.LineChartContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.MostTimeConsumingContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.MultilevelValidatorStrategy;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.NotPassedTestsContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.OverallStatisticsContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.PassingRatePerLaunchContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.PassingRateSummaryContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.ProductStatusContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.TestCaseSearchValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.TopPatternContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.TopTestCasesContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.UniqueBugContentValidator;
import com.epam.reportportal.serviceapi.core.widget.content.updater.validator.WidgetValidatorStrategy;
