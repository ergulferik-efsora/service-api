...
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.ATTRIBUTES_OPERATOR;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.EMPTY_STRING;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.ENABLED;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.LAUNCH_NAMES;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.RECIPIENTS;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.RULE_DETAILS;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.SEND_CASE;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.TYPE;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.processBoolean;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.processList;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.processMap;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.processName;
import static com.epam.reportportal.serviceapi.core.events.activity.util.ActivityDetailsUtil.processString;
  ...
  private static Optional<HistoryField> processAttributesSet(Set<ItemAttributeResource> before,
    ...
    if (!left.equals(right)) {
      return Optional.of(HistoryField.of(
          ActivityDetailsUtil.ATTRIBUTES, String.join(", ", left),
          String.join(", ", right)));
    }
