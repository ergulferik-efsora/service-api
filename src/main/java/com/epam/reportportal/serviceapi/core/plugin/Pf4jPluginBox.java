...
package com.epam.reportportal.serviceapi.core.plugin;
...
import com.epam.reportportal.serviceapi.plugin.Pf4jPluginManager;
...
public interface Pf4jPluginBox extends PluginBox {
   ...
   *                 {@link Pf4jPluginManager#uploadingPlugins} which uploaded state is
   *                 required
   * @return 'true' if {@link Pf4jPluginManager#uploadingPlugins} contains plugin file
   * name, else 'false'
