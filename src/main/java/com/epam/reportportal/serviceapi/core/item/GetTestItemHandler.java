...
package com.epam.reportportal.serviceapi.core.item;
...
public interface GetTestItemHandler {
   ...
   * @param term     part of {@link Ticket#ticketId} to
   *                 search
   ...
   * @param value    part of the {@link ItemAttribute#value} to
   *                 search
   ...
   * {@link Project} specified by `projectDetails`
   *
   * @param membershipDetails {@link MembershipDetails}
