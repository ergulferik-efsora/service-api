...
package com.epam.reportportal.serviceapi.core.analyzer.pattern.selector.condition;

import com.epam.reportportal.serviceapi.core.analyzer.auto.strategy.analyze.AnalyzeItemsMode;
import com.epam.reportportal.serviceapi.core.analyzer.pattern.selector.condition.impl.AutoAnalyzedPatternConditionProvider;
import com.epam.reportportal.serviceapi.core.analyzer.pattern.selector.condition.impl.IgnoreImmediatePatternAnalysisConditionProvider;
import com.epam.reportportal.serviceapi.core.analyzer.pattern.selector.condition.impl.ManualPatternConditionProvider;
import com.epam.reportportal.serviceapi.core.analyzer.pattern.selector.condition.impl.ToInvestigatePatternConditionProvider;
