...
package com.epam.reportportal.serviceapi.core.item.impl.history.param;
...
import com.epam.reportportal.serviceapi.ws.controller.TestItemController;
import java.util.Arrays;
import java.util.Optional;

/**
 * NULL-safe container for {@link TestItemController#getItemsHistory} request
 * params
 *
...
public class HistoryRequestParams {
  ...
  /**
   * Container for {@link TestItemController#getItemsHistory} launch's
