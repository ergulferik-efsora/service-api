...
import com.epam.reportportal.serviceapi.core.item.impl.status.ToFailedStatusChangingStrategy;
import com.epam.reportportal.serviceapi.core.item.impl.status.ToPassedStatusChangingStrategy;
import com.epam.reportportal.serviceapi.core.item.impl.status.ToSkippedStatusChangingStrategy;
