...
import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MAX_PHOTO_HEIGHT;
import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MAX_PHOTO_SIZE;
import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MAX_PHOTO_WIDTH;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates.equalTo;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.user.UserType.INTERNAL;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.BINARY_DATA_CANNOT_BE_SAVED;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.FORBIDDEN_OPERATION;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.USER_ALREADY_EXISTS;
import static com.epam.reportportal.serviceapi.util.email.EmailRulesValidator.NORMALIZE_EMAIL;
import static java.util.Optional.ofNullable;

import com.epam.reportportal.serviceapi.core.events.activity.ChangeUserTypeEvent;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ImageFormat;
