...
package com.epam.reportportal.serviceapi.core.analyzer.pattern.handler.proxy;

import static com.epam.reportportal.serviceapi.core.analyzer.auto.impl.AnalyzerStatusCache.PATTERN_ANALYZER_KEY;
import static com.epam.reportportal.serviceapi.core.analyzer.config.PatternAnalysisRabbitConfiguration.PATTERN_ANALYSIS_REGEX;
import static com.epam.reportportal.serviceapi.core.analyzer.config.PatternAnalysisRabbitConfiguration.PATTERN_ANALYSIS_STRING;

import com.epam.reportportal.serviceapi.core.analyzer.auto.impl.AnalyzerStatusCache;
import com.epam.reportportal.serviceapi.core.analyzer.pattern.handler.impl.ItemsPatternAnalyzerImpl;
