...
package com.epam.reportportal.serviceapi.core.dashboard.impl;

import static com.epam.reportportal.serviceapi.ws.converter.converters.DashboardConverter.TO_ACTIVITY_RESOURCE;
...
import com.epam.reportportal.serviceapi.core.events.activity.DashboardUpdatedEvent;
import com.epam.reportportal.serviceapi.core.events.activity.WidgetDeletedEvent;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.dao.DashboardWidgetRepository;
