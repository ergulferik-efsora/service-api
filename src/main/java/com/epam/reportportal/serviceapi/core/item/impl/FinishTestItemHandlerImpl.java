...
import static com.epam.reportportal.serviceapi.core.hierarchy.AbstractFinishHierarchyHandler.ATTRIBUTE_KEY_STATUS;
import static com.epam.reportportal.serviceapi.core.hierarchy.AbstractFinishHierarchyHandler.ATTRIBUTE_VALUE_INTERRUPTED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates.equalTo;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.FAILED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.INFO;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.INTERRUPTED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.IN_PROGRESS;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.PASSED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.SKIPPED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.WARN;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.fromValue;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.NOT_ISSUE_FLAG;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.TO_INVESTIGATE;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.AMBIGUOUS_TEST_ITEM_STATUS;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.FINISH_ITEM_NOT_ALLOWED;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.LAUNCH_NOT_FOUND;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.TEST_ITEM_NOT_FOUND;
import static com.epam.reportportal.serviceapi.util.Predicates.ITEM_CAN_BE_INDEXED;
import static com.epam.reportportal.serviceapi.ws.converter.converters.TestItemConverter.TO_ACTIVITY_RESOURCE;
...
import com.epam.reportportal.serviceapi.core.events.activity.item.TestItemStatusChangedEvent;
import com.epam.reportportal.serviceapi.core.hierarchy.FinishHierarchyHandler;
import com.epam.reportportal.serviceapi.core.item.ExternalTicketHandler;
import com.epam.reportportal.serviceapi.core.item.FinishTestItemHandler;
import com.epam.reportportal.serviceapi.core.item.impl.retry.RetryHandler;
import com.epam.reportportal.serviceapi.core.item.impl.retry.RetrySearcher;
import com.epam.reportportal.serviceapi.core.item.impl.status.ChangeStatusHandler;
import com.epam.reportportal.serviceapi.core.item.impl.status.StatusChangingStrategy;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.dao.IssueEntityRepository;
...
import com.epam.reportportal.serviceapi.model.activity.TestItemActivityResource;
