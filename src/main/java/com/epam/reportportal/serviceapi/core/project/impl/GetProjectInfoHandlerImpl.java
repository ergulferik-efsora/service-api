...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.EntityUtils.INSTANT_TO_TIMESTAMP;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.Condition.GREATER_THAN_OR_EQUALS;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.Condition.IN;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.DELETE_DEFECT;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.LINK_ISSUE;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.LINK_ISSUE_AA;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.UNLINK_ISSUE;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.UPDATE_DEFECT;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction.UPDATE_ITEM;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.project.email.ProjectInfoWidget.CASES_STATISTIC;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.project.email.ProjectInfoWidget.INVESTIGATED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.project.email.ProjectInfoWidget.ISSUES_CHART;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.project.email.ProjectInfoWidget.LAUNCHES_QUANTITY;
...
import static com.epam.reportportal.serviceapi.ws.converter.converters.ActivityConverter.TO_RESOURCE;
import static com.epam.reportportal.serviceapi.ws.converter.converters.ActivityConverter.TO_RESOURCE_WITH_USER;
import static java.util.Optional.ofNullable;
import static java.util.stream.Collectors.joining;
import static java.util.stream.Collectors.toList;
import static java.util.stream.Collectors.toMap;

import com.epam.reportportal.serviceapi.core.project.GetProjectInfoHandler;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityAction;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.project.email.ProjectInfoWidget;
...
import com.epam.reportportal.serviceapi.model.project.LaunchesPerUser;
import com.epam.reportportal.serviceapi.model.project.ProjectInfoResource;
...
import com.epam.reportportal.serviceapi.ws.converter.converters.ProjectSettingsConverter;
...
public class GetProjectInfoHandlerImpl implements GetProjectInfoHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<ProjectInfoResource> getAllProjectsInfo(
