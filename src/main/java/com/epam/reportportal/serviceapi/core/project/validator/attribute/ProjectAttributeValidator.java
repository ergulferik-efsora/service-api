...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.ALL_MESSAGES_SHOULD_MATCH;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.AUTO_ANALYZER_ENABLED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.AUTO_ANALYZER_MODE;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.AUTO_UNIQUE_ERROR_ANALYZER_ENABLED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.FOREVER_ALIAS;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.INDEXING_RUNNING;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.INTERRUPT_JOB_TIME;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.KEEP_LAUNCHES;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.KEEP_LOGS;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.KEEP_SCREENSHOTS;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.LARGEST_RETRY_PRIORITY;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.NOTIFICATIONS_EMAIL_ENABLED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.NOTIFICATIONS_ENABLED;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.SEARCH_LOGS_MIN_SHOULD_MATCH;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.ProjectAttributeEnum.UNIQUE_ERROR_ANALYZER_REMOVE_NUMBERS;
