...
package com.epam.reportportal.serviceapi.core.configs.event.subscriber;
...
import com.epam.reportportal.serviceapi.core.events.handler.item.TestItemAutoAnalysisRunner;
import com.epam.reportportal.serviceapi.core.events.handler.item.TestItemIndexRunner;
import com.epam.reportportal.serviceapi.core.events.handler.item.TestItemPatternAnalysisRunner;
import com.epam.reportportal.serviceapi.core.events.handler.item.TestItemUniqueErrorAnalysisRunner;
import com.epam.reportportal.serviceapi.core.events.handler.launch.LaunchAnalysisFinishEventPublisher;
import com.epam.reportportal.serviceapi.core.events.handler.launch.LaunchAutoAnalysisRunner;
import com.epam.reportportal.serviceapi.core.events.handler.launch.LaunchNotificationRunner;
import com.epam.reportportal.serviceapi.core.events.handler.launch.LaunchPatternAnalysisRunner;
import com.epam.reportportal.serviceapi.core.events.handler.launch.LaunchUniqueErrorAnalysisRunner;
