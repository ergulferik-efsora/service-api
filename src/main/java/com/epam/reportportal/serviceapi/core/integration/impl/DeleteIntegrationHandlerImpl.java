...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.INTEGRATION_NOT_FOUND;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.PROJECT_NOT_FOUND;
import static com.epam.reportportal.serviceapi.ws.converter.converters.IntegrationConverter.TO_ACTIVITY_RESOURCE;

import com.epam.reportportal.serviceapi.core.events.activity.IntegrationDeletedEvent;
