...
import static com.epam.reportportal.serviceapi.core.widget.content.constant.ContentLoaderConstants.RESULT;
import static com.epam.reportportal.serviceapi.infrastructure.model.ValidationConstraints.MAX_LAUNCH_NAME_LENGTH;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Preconditions.HAS_ANY_MODE;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Preconditions.statusIn;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.Condition.EQUALS;
...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.StatusEnum.IN_PROGRESS;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.INCORRECT_FILTER_PARAMETERS;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.LAUNCH_NOT_FOUND;
...
import com.epam.reportportal.serviceapi.core.launch.cluster.GetClusterHandler;
import com.epam.reportportal.serviceapi.core.launch.export.LaunchExportService;
import com.epam.reportportal.serviceapi.extension.event.GetLaunchResourceCollectionEvent;
import com.epam.reportportal.serviceapi.infrastructure.model.launch.cluster.ClusterInfoResource;
import com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.ProjectFilter;
...
import com.epam.reportportal.serviceapi.ws.converter.converters.LaunchConverter;
...
/**
 * Default implementation of {@link GetLaunchHandler}
 *
...
public class GetLaunchHandlerImpl implements GetLaunchHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<LaunchResource> getProjectLaunches(
   ...
   */
  @Override
  public com.epam.reportportal.serviceapi.model.Page<LaunchResource> getDebugLaunches(
      MembershipDetails membershipDetails,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<LaunchResource> getLatestLaunches(
      MembershipDetails membershipDetails,
      Filter filter, Pageable pageable) {
  ...
  public com.epam.reportportal.serviceapi.model.Page<ClusterInfoResource> getClusters(String launchId,
  ...
  private com.epam.reportportal.serviceapi.model.Page<LaunchResource> getLaunchResources(
      Page<Launch> launches) {
    final com.epam.reportportal.serviceapi.model.Page<LaunchResource> launchResourcePage =
