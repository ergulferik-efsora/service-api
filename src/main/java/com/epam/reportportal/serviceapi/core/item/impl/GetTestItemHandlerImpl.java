...
import com.epam.reportportal.serviceapi.core.item.impl.provider.DataProviderHandler;
import com.epam.reportportal.serviceapi.core.item.impl.provider.DataProviderType;
import com.epam.reportportal.serviceapi.core.item.utils.DefaultLaunchFilterProvider;
...
import com.epam.reportportal.serviceapi.ws.converter.converters.StatisticsConverter;
...
class GetTestItemHandlerImpl implements GetTestItemHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<TestItemResource> getTestItems(Queryable filter,
      Pageable pageable,
      MembershipDetails membershipDetails, ReportPortalUser user,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<TestItemResource> getTestItemsByProvider(
