...
import static com.epam.reportportal.serviceapi.ws.resolver.PagingHandlerMethodArgumentResolver.CUT_DEFAULT_OFFSET;
import static com.epam.reportportal.serviceapi.ws.resolver.PagingHandlerMethodArgumentResolver.CUT_DEFAULT_PAGE_SIZE;
...
import com.epam.reportportal.serviceapi.model.Page.PageMetadata;
...
public class TestCaseSearchHandler {
  ...
  public Page<TestItemResource> searchTestItems(String namePart, String attribute,
    ...
    return new Page<>(result.stream().map(item -> {
