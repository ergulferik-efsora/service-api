...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates.in;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.Predicates.not;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.AUTOMATION_BUG;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.NO_DEFECT;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.PRODUCT_BUG;
import static com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.TestItemIssueGroup.SYSTEM_ISSUE;
...
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.FORBIDDEN_OPERATION;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.ISSUE_TYPE_NOT_FOUND;
import static com.epam.reportportal.serviceapi.infrastructure.rules.exception.ErrorType.PROJECT_NOT_FOUND;
import static com.epam.reportportal.serviceapi.ws.converter.converters.IssueTypeConverter.TO_ACTIVITY_RESOURCE;
import static java.util.Optional.ofNullable;

import com.epam.reportportal.serviceapi.core.events.MessageBus;
import com.epam.reportportal.serviceapi.core.events.activity.DefectTypeUpdatedEvent;
import com.epam.reportportal.serviceapi.core.events.activity.PatternUpdatedEvent;
import com.epam.reportportal.serviceapi.core.project.settings.UpdateProjectSettingsHandler;
import com.epam.reportportal.serviceapi.model.project.config.pattern.UpdatePatternTemplateRQ;
...
import com.epam.reportportal.serviceapi.model.activity.IssueTypeActivityResource;
import com.epam.reportportal.serviceapi.model.activity.PatternTemplateActivityResource;
import com.epam.reportportal.serviceapi.model.project.config.UpdateIssueSubTypeRQ;
import com.epam.reportportal.serviceapi.model.project.config.UpdateOneIssueSubTypeRQ;
