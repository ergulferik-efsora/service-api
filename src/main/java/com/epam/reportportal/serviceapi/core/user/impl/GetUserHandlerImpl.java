...
import static com.epam.reportportal.serviceapi.ws.converter.converters.UserConverter.TO_INSTANCE_USER;
import static java.util.Optional.ofNullable;
import static java.util.stream.Collectors.toMap;

import com.epam.reportportal.serviceapi.api.model.InstanceUser;
import com.epam.reportportal.serviceapi.api.model.InstanceUserPage;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.group.GroupProject;
...
public class GetUserHandlerImpl implements GetUserHandler {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<UserResource> getUsers(Filter filter, Pageable pageable,
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<UserResource> getAllUsers(Queryable filter, Pageable pageable) {
  ...
  @Override
  public com.epam.reportportal.serviceapi.model.Page<UserResource> searchUsers(String term, Pageable pageable) {
