...
package com.epam.reportportal.serviceapi.core.file;

import static com.epam.reportportal.serviceapi.core.configs.rabbit.InternalConfiguration.EXCHANGE_ATTACHMENT;
import static com.epam.reportportal.serviceapi.core.configs.rabbit.InternalConfiguration.QUEUE_ATTACHMENT_DELETE;

import com.epam.reportportal.serviceapi.core.events.MessageBus;
import com.epam.reportportal.serviceapi.core.events.attachment.DeleteAttachmentEvent;
