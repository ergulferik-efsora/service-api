...
package com.epam.reportportal.serviceapi.plugin;
...
import com.epam.reportportal.serviceapi.core.plugin.Plugin;
...
import com.epam.reportportal.serviceapi.extension.common.ExtensionPoint;
import com.epam.reportportal.serviceapi.extension.common.IntegrationTypeProperties;
import com.epam.reportportal.serviceapi.extension.event.PluginEvent;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.enums.PluginTypeEnum;
...
import com.epam.reportportal.serviceapi.infrastructure.persistence.entity.plugin.PluginFileExtension;
...
import com.epam.reportportal.serviceapi.job.CleanOutdatedPluginsJob;
import com.epam.reportportal.serviceapi.ws.converter.builders.IntegrationTypeBuilder;
 ...
 * {@link CleanOutdatedPluginsJob} to prevent the removing of the plugins that are still being
...
public class Pf4jPluginManager implements Pf4jPluginBox {
   ...
   *                 {@link Pf4jPluginManager#uploadingPlugins}
   * @param path     Full path to the plugin file
   * @see Pf4jPluginManager
   */
