...
import com.epam.reportportal.serviceapi.api.model.ActivityDetails;
import com.epam.reportportal.serviceapi.api.model.HistoryField;
...
public final class ActivityEventConverter {
  ...
  public static final Function<Activity, com.epam.reportportal.serviceapi.api.model.Activity> TO_ACTIVITY_RESOURCE =
      activity -> new com.epam.reportportal.serviceapi.api.model.Activity()
          .id(activity.getId())
          .createdAt(activity.getCreatedAt())
  ...
  private static ActivityDetails convertDetails(
      com.epam.reportportal.serviceapi.infrastructure.persistence.entity.activity.ActivityDetails detailsEntity) {
