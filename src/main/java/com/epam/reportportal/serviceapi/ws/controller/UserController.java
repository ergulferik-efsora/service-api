...
import static com.epam.reportportal.serviceapi.auth.permissions.Permissions.ALLOWED_TO_EDIT_USER;
import static com.epam.reportportal.serviceapi.auth.permissions.Permissions.ALLOWED_TO_OWNER;
import static com.epam.reportportal.serviceapi.auth.permissions.Permissions.IS_ADMIN;
import static com.epam.reportportal.serviceapi.core.jasper.ReportFormat.CSV;
import static org.springframework.http.HttpStatus.CREATED;
import static org.springframework.http.HttpStatus.OK;

import com.epam.reportportal.serviceapi.core.jasper.GetJasperReportHandler;
import com.epam.reportportal.serviceapi.core.jasper.ReportFormat;
import com.epam.reportportal.serviceapi.core.launch.util.LinkGenerator;
import com.epam.reportportal.serviceapi.core.user.ApiKeyHandler;
import com.epam.reportportal.serviceapi.core.user.CreateUserHandler;
import com.epam.reportportal.serviceapi.core.user.DeleteUserHandler;
import com.epam.reportportal.serviceapi.core.user.EditUserHandler;
import com.epam.reportportal.serviceapi.core.user.GetUserHandler;
import com.epam.reportportal.serviceapi.infrastructure.persistence.commons.EntityUtils;
...
import com.epam.reportportal.serviceapi.model.ApiKeyRQ;
import com.epam.reportportal.serviceapi.model.ApiKeyRS;
import com.epam.reportportal.serviceapi.model.ApiKeysRS;
import com.epam.reportportal.serviceapi.model.DeleteBulkRS;
import com.epam.reportportal.serviceapi.model.ModelViews;
import com.epam.reportportal.serviceapi.model.Page;
import com.epam.reportportal.serviceapi.model.YesNoRS;
import com.epam.reportportal.serviceapi.model.user.ChangePasswordRQ;
import com.epam.reportportal.serviceapi.model.user.EditUserRQ;
import com.epam.reportportal.serviceapi.model.user.ResetPasswordRQ;
import com.epam.reportportal.serviceapi.model.user.RestorePasswordRQ;
import com.epam.reportportal.serviceapi.model.user.UserResource;
import com.epam.reportportal.serviceapi.reporting.OperationCompletionRS;
import com.epam.reportportal.serviceapi.ws.resolver.ActiveRole;
import com.epam.reportportal.serviceapi.ws.resolver.FilterFor;
import com.epam.reportportal.serviceapi.ws.resolver.ResponseView;
