...
package com.epam.reportportal.serviceapi.ws.converter;

import com.epam.reportportal.serviceapi.model.PagedResponse;
...
public abstract class PagedResourcesAssembler<T, R> extends ResourceAssembler<T, R> {
  ...
  public static <T> Function<Page<T>, com.epam.reportportal.serviceapi.model.Page<T>> pageConverter() {
    return page -> new com.epam.reportportal.serviceapi.model.Page<>(page.getContent(),
        new com.epam.reportportal.serviceapi.model.Page.PageMetadata(page.getSize(),
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.serviceapi.model.Page<R>> pageConverter(
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.serviceapi.model.Page<R>> pageMultiConverter(
  ...
  /**
   * Creates {@link com.epam.reportportal.serviceapi.model.Page} from {@link Page} DB query result
   *
   ...
   */
  @Deprecated
  public com.epam.reportportal.serviceapi.model.Page<R> toPagedResources(Page<T> content) {
    Preconditions.checkNotNull(content, "Content should be null");

    return new com.epam.reportportal.serviceapi.model.Page<>(toResources(content),
        new com.epam.reportportal.serviceapi.model.Page.PageMetadata(content.getSize(),
