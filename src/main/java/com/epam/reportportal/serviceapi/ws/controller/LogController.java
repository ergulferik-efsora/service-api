...
import static com.epam.reportportal.serviceapi.infrastructure.persistence.commons.querygen.Condition.UNDR;
...
import static com.epam.reportportal.serviceapi.util.ControllerUtils.findByFileName;
import static com.epam.reportportal.serviceapi.util.ControllerUtils.getUploadedFiles;
import static com.epam.reportportal.serviceapi.util.ControllerUtils.validateSaveRQ;
...
import com.epam.reportportal.serviceapi.core.analyzer.auto.SearchLogService;
import com.epam.reportportal.serviceapi.core.log.CreateLogHandler;
import com.epam.reportportal.serviceapi.core.log.DeleteLogHandler;
import com.epam.reportportal.serviceapi.core.log.GetLogHandler;
import com.epam.reportportal.serviceapi.core.log.impl.PagedLogResource;
...
import com.epam.reportportal.serviceapi.model.log.GetLogsUnderRq;
import com.epam.reportportal.serviceapi.model.log.LogResource;
import com.epam.reportportal.serviceapi.model.log.SearchLogRq;
import com.epam.reportportal.serviceapi.model.log.SearchLogRs;
import com.epam.reportportal.serviceapi.reporting.BatchElementCreatedRS;
import com.epam.reportportal.serviceapi.reporting.BatchSaveOperatingRS;
import com.epam.reportportal.serviceapi.reporting.Constants;
